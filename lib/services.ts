...
export const services: Service[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Vitrectomy surgery & intravitreal injections",
      "OCT imaging"
    ],
  ...
  },
  {
    ...
    shortDescription: "World-class cataract surgery with latest stitchless phaco techniques and premium IOL options.",
    longDescription:
    ...
    highlights: [
      ...
      "Monofocal, multifocal, trifocal, EDOF IOLs",
  ...
  },
  {
    slug: "lasik-surgery",
    name: "LASIK Surgery",
    shortDescription: "Blade-free LASIK, C-LASIK, SMILE, and ICL for vision correction with world-class technology.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "ISO 9002 state-of-the-art glasses with latest Indian & international frame varieties.",
    longDescription:
